    ...
    const cmsUiTexts = useMemo(() => {
        if (language === "de") {
            return {
                ...
                autoTranslateIncomplete: "Automatische Übersetzung ist unvollständig. Fehlende Sprachen:",
        ...
        if (language === "en") {
            return {
                ...
                autoTranslateIncomplete: "Automatic translation is incomplete. Missing languages:",
        ...
        if (language === "sk") {
            ...
            autoTranslateIncomplete: "Automatický preklad je neúplný. Chýbajú jazyky:",
        ...
        return {
            ...
            autoTranslateIncomplete: "Automatický překlad je neúplný. Chybí jazyky:",
